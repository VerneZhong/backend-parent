package com.zxb.meetingfilm.testng.conf;
...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    public static final String REPORT_NAME = "钟学斌的测试报告";
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : result.values()) {
                ...
                if (resultNode != null) {
                    ...
                    resultNode.getModel().setDescription(String.format("Pass: %s ; Fail: %s ; Skip: %s ;", passSize,
                            failSize, skipSize));
                }
            ...
            if (suiteTest != null) {
                suiteTest.getModel().setDescription(String.format("Pass: %s ; Fail: %s ; Skip: %s ;", suitePassSize,
